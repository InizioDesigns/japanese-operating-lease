...
const investorsContent = {
    ...
    "ja": {
        title: "投資家の皆さまへの利益",
        intro: "Babcock & Brownは、新たな投資機会を調達するため、世界的なリレーションシップを活用します。調達されると、B&Bは取引のストラクチャリングを行い、適用されるデュー・デリジェンスを実施し、その後適切な投資家に対しそれらによる評価のために取引を提示します。B&Bは、投資家のポートフォリオに長期的に貢献する取引を提示することを、誇りとしています。",
