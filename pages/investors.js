...
const investorsContent = {
    ...
    "ja": {
        ...
        list2: [
          "Babcock & Brown証券は、独自のグローバルリレーションシップと長年蓄積した高度なノウハウを活用し、お客様のニーズに合った商品の開発と組成を目的とし, 新たな投資機会のオリジネーション、ストラクチャーリング、デュー・デリジェンスサービスを提供しています。B&Bは、投資家のポートフォリオに長期的に貢献する取引を提案することを、誇りとしています。",
        ],
        sub: [
