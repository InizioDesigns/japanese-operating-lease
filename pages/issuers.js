...
const issuersContent = {
    ...
    "ja": {
      title: "設備投資型産業における発行会社",
      intro: "Babcock & Brown証券は、最適な資金調達戦略など、ストラクチャード ファイナンス (不動産、ローン、リースなど将来一定のキャッシュフローが見込める資産を裏付けとして発行される株式や債券等) を通じた資金調達を支援するフィナンシャル・アドバイザーです。発行会社のお客様は、新たな投資家を発掘し、資金調達源を多様化し、より洗練された資金調達ストラクチャーにアクセスするために、Babcock & Brown証券に助言を求めます。Babcock & Brown証券は、長期にわたり継続する顧客との関係を構築することに注力しています。",
