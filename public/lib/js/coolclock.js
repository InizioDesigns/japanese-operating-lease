...
CoolClock.prototype = {
	...
	refreshDisplay: function() {
		...
		if (this.gmtOffset != null) {
			...
			// I added the +1 below to adjust for daylight savings cause I didn't have time to figure it out. MSK
            // I then removed it again because it's not daylight savings time and I still don't want to take the time
...
CoolClock.config.skins = {
	...
	burnham: {
		outerBorder: { lineWidth: 3, radius:95, color: "white", alpha: 1 },
		...
		hourHand: { lineWidth: 9, startAt: -15, endAt: 50, color: "white", alpha: 1 },
		minuteHand: { lineWidth: 5, startAt: -15, endAt: 75, color: "white", alpha: 1 },
		secondHand: { lineWidth: 1, startAt: -20, endAt: 85, color: "red", alpha: 1 },
		secondDecoration: { lineWidth: 1, startAt: 70, radius: 4, fillColor: "red", color: "red", alpha: 1 }
	},
	swissRail: {
